...
public class EntityKakkerlak extends EntityTameable
{
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        else if (itemstack != null && itemstack.getItem() == Items.rotten_flesh && !this.isAngry())
        {
            if (!par1EntityPlayer.capabilities.isCreativeMode)
            {
                --itemstack.stackSize;
    ...
    public EntityKakkerlak createChild(EntityAgeable par1EntityAgeable)
    {
        EntityKakkerlak entitywolf = new EntityKakkerlak(this.worldObj);
