                                                 ...
                                                 for (j3 = 0; j3 < 3; ++j3)
                                                 {
                                                         for (i4 = 0; i4 < 4; ++i4)
                                                         {
                                                                 for (l3 = -1; l3 < 4; ++l3)
                                                                 {
                                                                         ...
                                                                         if (l3 < 0 && !this.worldServerInstance.getBlock(k4, j4, l4).isBlockNormalCube() || l3 >= 0 && !this.worldServerInstance.isAirBlock(k4, j4, l4))
                                                                         {
                                                                                 continue label274;
                                                                         }
                                                                 }
                                                 ...
                                                 for (i3 = l1; i3 < l1 + 2; ++i3)
                                                 {
                                                         ...
                                                         for (j3 = 0; j3 < 4; ++j3)
                                                         {
                                                                 for (i4 = -1; i4 < 4; ++i4)
                                                                 {
                                                                         ...
                                                                         k4 = k2 + i4;
                                                                         j4 = j2 + (j3 - 1) * k3;
                                                                         if (i4 < 0 && !this.worldServerInstance.getBlock(l3, k4, j4).isBlockNormalCube() || i4 >= 0 && !this.worldServerInstance.isAirBlock(l3, k4, j4))
                                                                         {
                                                                                 continue label222;
                                                                         }
                                                                 }
                 ...
                 for (k2 = -1; k2 <= 1; ++k2)
                 {
                         for (i3 = 1; i3 < 3; ++i3)
                         {
                                 for (l2 = -1; l2 < 3; ++l2)
                                 {
                                         ...
                                         /** change this block **/
                                         this.worldServerInstance.setBlock(k3, j3, i4, Blocks.mossy_cobblestone, 0, 0);
                                 }
                         }
                 }
         }
